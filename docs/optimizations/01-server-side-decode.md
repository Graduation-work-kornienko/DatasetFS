...
**Статус**: Итерация 2 (libjpeg-turbo) в работе. ResNet-18 A/B готов — gap схлопнулся с -14% до -1.4%. SimpleCNN A/B (loader-bound сценарий) ещё не прогнан, ждёт продолжения сессии.
